        ...
        <section id="contact" className="relative flex flex-col items-center justify-center h-full min-h-screen p-4 text-white lg:px-0 bg-gradient-to-b from-gray-900 to-gray-700">
            ...
            <div className="flex flex-col w-full max-w-3xl gap-4 mx-auto text-center">
                ...
                <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6 py-5 duration-500 animate-fadeIn">
                    ...
                    <button type="submit" disabled={sending} className="px-6 py-3 font-semibold transition bg-indigo-600 rounded-lg hover:bg-indigo-700 disabled:opacity-50">
                ...
                <div className="flex justify-center gap-6 duration-500 animate-fadeIn">
                    <a href="https://github.com/Anuj-789" target="_blank" rel="noopener noreferrer" className="transition hover:scale-110" aria-label="GitHub">
                        <GithubInIcon />
                    </a>

                    <a href="https://www.linkedin.com/in/anuj-k-549184327" target="_blank" rel="noopener noreferrer" className="transition hover:scale-110" aria-label="LinkedIn">
                        <LinkedInIcon />
                    </a>

                    <a href="https://t.me/AK_Gupta110" target="_blank" rel="noopener noreferrer" className="transition hover:scale-110" aria-label="Telegram">
                        <TelegramIcon />
                    </a>
                </div>
            </div>
